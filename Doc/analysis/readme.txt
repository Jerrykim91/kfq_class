...
3. 데이터
 ...
 - 데이터의 종류
  ...
  6) 오디오, 비디오 데이터
    - 가장 까다롭운 데이터
    - 2014년기준 MLB에서 생중계 시 , 경기 분석을 하기 위해서 영상으리 분량을 경기단 7TB로 늘려서
      처리. 고속 카메라가 공, 선수의 움직임을 다 포착하여 베이스라인과 비교등을 실시간 계산 처리
